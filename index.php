...
<head>
  ...
  <?php
  // require "get in touch.php";
  require "book appointment.php";
  require "slider.php"; 
  require "treatmentfunction.php";
  require "doctorsfunction.php";
  require "testimonialfunction.php";
  require "categoriesFunction.php"
...
<div class="dot_design">
    ...
    <?php
      printSlider(  "Mico <br> <span>Hospital</span>","when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to",
...
<div class="carousel_btn-box">
  ...
  <section class="team_section layout_padding">
    ...
    <?php
        printDoctors("Hennry", "MBBS", "images/team1.jpg");
        printDoctors("Jenny", "MBBS", "images/team2.jpg");
        printDoctors("Morco", "MBBS", "images/team3.jpg");
    ?>
